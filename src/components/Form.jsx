        ...
        <div className="col col-lg-4 col-12">
            <form action="/" className="form-control" onSubmit={handleSubmit}>
                <div className="form-group"><br />
                    ...
                    <input type="number" className="form-control" id="num-of-nodes" name="numOfNodes"  min="1" max="100" required /><br />
                </div>                         
                <div className="form-group">                    
                    <span> Type of edges: </span><br />
                    <div className="row">
                        <div className="col">
                ...
                <div className="form-group">
                    ...
                    <input type="number" className="form-control" id="start-node" name="startNode"  min="1" defaultValue="1" required /><br />
                </div>
                <div className="form-group">
                    <label htmlFor="end-node">End node: &nbsp;</label>
                    <input type="number" className="form-control" id="end-node" name="endNode"  min="1" />
                    <span>(for path finding algorithms)</span><br /><br /><br />
                </div>
                <input type="submit" className="btn btn-primary" id="visualize" value="Visualize" /> &nbsp;
                <input type="reset" className="btn btn-secondary" id="reset" onClick={handleReset} value="Reset" /><br />
            </form>
        </div>
    )
}
